...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-footer" style="text-align: right;">
            <a href="{{ route('mahasiswa.proposal.index') }}" class="btn btn-secondary mr-5"><i
    ...
    <script>
        $(document).ready(function() {
            $('#form-edit').submit(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('mahasiswa.proposal.update', ':id') }}".replace(':id', id),
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(response) {
                        ...
                        Swal.fire({
                            ...
                            window.location = "{{ route('mahasiswa.proposal.index') }}";
                        });
                    },
