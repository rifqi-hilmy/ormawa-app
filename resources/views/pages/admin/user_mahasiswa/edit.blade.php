                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="nim" id="nim"
                                value="{{ $mahasiswa->mahasiswa->nim }}" required>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="id_organisasi" id="id_organisasi" required>
                                ...
                                @foreach ($organisasi as $org)
                                    <option value="{{ $org->id }}"
                                        {{ $mahasiswa->mahasiswa->id_organisasi == $org->id ? 'selected' : '' }}>
                                        {{ $org->nama_organisasi }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="no_hp" id="no_hp"
                                value="{{ $mahasiswa->mahasiswa->no_hp }}" required>
                            <span class="invalid-feedback">
                            ...
                            <div class="d-flex mt-2">
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="laki_laki"
                                        value="L" {{ $mahasiswa->mahasiswa->jenis_kelamin === 'L' ? 'checked' : '' }}
                                        required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="perempuan"
                                        value="P" {{ $mahasiswa->mahasiswa->jenis_kelamin === 'P' ? 'checked' : '' }}
                                        required>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" name="alamat" id="alamat" rows="10">{{ $mahasiswa->mahasiswa->alamat }}</textarea>
                            <span class="invalid-feedback">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form-edit').submit(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.mahasiswa.update', ':id') }}".replace(':id', id),
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
