...
@section('content')
    ...
    <div class="card">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="nip" id="nip"
                                value="{{ $dosen->dosen->nip }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="nidn" id="nidn"
                                value="{{ $dosen->dosen->nidn }}" required>
                            <span class="invalid-feedback">
                            ...
                            <select class="form-control select2" name="id_prodi" id="id_prodi" required>
                                ...
                                @foreach ($prodi as $prod)
                                    <option value="{{ $prod->id }}"
                                        {{ $dosen->dosen->id_prodi == $prod->id ? 'selected' : '' }}>
                                        {{ $prod->nama_prodi }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="no_hp" id="no_hp"
                                value="{{ $dosen->dosen->no_hp }}" required>
                            <span class="invalid-feedback">
                            ...
                            <div class="d-flex mt-2">
                                <div class="form-check me-3">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="laki_laki"
                                        value="L" {{ $dosen->dosen->jenis_kelamin === 'L' ? 'checked' : '' }}
                                        required>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="jenis_kelamin" id="perempuan"
                                        value="P" {{ $dosen->dosen->jenis_kelamin === 'P' ? 'checked' : '' }}
                                        required>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" name="alamat" id="alamat" rows="10">{{ $dosen->dosen->alamat }}</textarea>
                            <span class="invalid-feedback">
        ...
        <div class="card-footer" style="text-align: right;">
            <a href="{{ route('admin.dosen.index') }}" class="btn btn-secondary mr-5"><i
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#form-edit').submit(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.dosen.update', ':id') }}".replace(':id', id),
                    data: formData,
                    cache: false,
                    contentType: false,
                    processData: false,
