<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item {{ Route::currentRouteName() == 'mahasiswa.dashboard' ? 'active' : '' }}">
        ...
        <li class="menu-item {{ Route::currentRouteName() == 'mahasiswa.proposal.index' ? 'active' : '' }}">
            <a href="{{ route('mahasiswa.proposal.index') }}" class="menu-link">
                <i class="menu-icon tf-icons bx bx-book-bookmark"></i>
                <div data-i18n="Pengajuan Proposal">Pengajuan Proposal</div>
            </a>
        </li>
        <li class="menu-item {{ Route::currentRouteName() == 'mahasiswa.proposal.arsip' ? 'active' : '' }}">
            <a href="{{ route('mahasiswa.proposal.arsip') }}" class="menu-link">
        ...
        <li class="menu-item {{ Route::currentRouteName() == 'mahasiswa.agenda.index' ? 'active' : '' }}">
            <a href="{{ route('mahasiswa.agenda.index') }}" class="menu-link">
