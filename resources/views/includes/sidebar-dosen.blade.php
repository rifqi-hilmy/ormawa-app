<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item {{ Route::currentRouteName() == 'dosen.dashboard' ? 'active' : '' }}">
        ...
        <li class="menu-item {{ Route::currentRouteName() == 'dosen.proposal.index' ? 'active' : '' }}">
            <a href="{{ route('dosen.proposal.index') }}" class="menu-link">
