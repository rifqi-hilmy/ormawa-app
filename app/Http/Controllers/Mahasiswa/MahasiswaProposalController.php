...
class MahasiswaProposalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.mahasiswa.proposal.index');
    }
    ...
    {
        return view('pages.mahasiswa.proposal.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.mahasiswa.proposal.edit', compact('proposal'));
    }
    ...
    public function arsipProposal(Request $request)
    {
        ...
        return view('pages.mahasiswa.arsip_proposal.index');
    }
}
